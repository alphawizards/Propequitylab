      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-card rounded-lg shadow-card p-8 prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">2.2 Financial Information</h3>
            <p className="text-foreground mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground">
              To exercise these rights, please contact us at <a href="mailto:privacy@propequitylab.com" className="text-sage hover:underline">privacy@propequitylab.com</a>
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <p className="text-foreground mb-2">
                <strong>Email:</strong> <a href="mailto:privacy@propequitylab.com" className="text-sage hover:underline">privacy@propequitylab.com</a>
              </p>
              <p className="text-foreground mb-2">
