    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-card border-b border-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">Last updated: January 9, 2026</p>
        </div>
      </div>

      {/* Content */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-card rounded-lg shadow-card p-8 prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">3.2 Account Eligibility</h3>
            <p className="text-foreground mb-4">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">3.3 Account Responsibility</h3>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">5.1 Your Data</h3>
            <p className="text-foreground mb-4">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">5.2 Data Accuracy</h3>
            <p className="text-foreground mb-4">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">5.3 Data Backup</h3>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">6.2 Limited License</h3>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">7. Disclaimers and Limitations</h2>
            
            <h3 className="text-xl font-semibold text-foreground mb-3">7.1 No Financial Advice</h3>
            <div className="bg-gold-soft border-l-4 border-gold p-4 mb-4">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">7.2 No Guarantees</h3>
            <p className="text-foreground mb-4">
              We do not guarantee:
            </p>
            <ul className="list-disc pl-6 mb-4 text-foreground">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">7.3 "AS IS" Service</h3>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">10.2 Termination by Us</h3>
            <p className="text-foreground mb-4">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">10.3 Effect of Termination</h3>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground">
              Your use of the Service is also governed by our <Link to="/privacy-policy" className="text-sage hover:underline">Privacy Policy</Link>, which is incorporated into these Terms by reference. Please review our Privacy Policy to understand our data practices.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-4">12. Changes to the Service</h2>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">14.2 Dispute Resolution</h3>
            <p className="text-foreground">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-foreground mb-3">15.3 Waiver</h3>
            <p className="text-foreground mb-4">
          ...
          <section className="mb-8">
            ...
            <div className="bg-muted p-4 rounded-lg">
              <p className="text-foreground mb-2">
                <strong>Email:</strong> <a href="mailto:legal@propequitylab.com" className="text-sage hover:underline">legal@propequitylab.com</a>
              </p>
              <p className="text-foreground mb-2">
                <strong>Support:</strong> <a href="mailto:support@propequitylab.com" className="text-sage hover:underline">support@propequitylab.com</a>
              </p>
              <p className="text-foreground">
                <strong>Website:</strong> <a href="https://propequitylab.pages.dev" className="text-sage hover:underline">https://propequitylab.pages.dev</a>
              </p>
            </div>
          </section>
