  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-card rounded-lg shadow-card border border-border p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-foreground space-y-2 mb-4 ml-4">
          ...
          <section>
            ...
            <p className="text-foreground mt-4 leading-relaxed">
              To exercise these rights, visit your <Link to="/settings" className="text-sage hover:text-sage/80 font-semibold">Settings</Link> page
              or contact us at <a href="mailto:privacy@propequitylab.com.au" className="text-sage hover:text-sage/80">privacy@propequitylab.com.au</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-foreground space-y-2 mt-2 ml-4">
          ...
          <section>
            ...
            <div className="bg-muted border border-border rounded-lg p-4">
              <p className="text-foreground"><strong>Email:</strong> <a href="mailto:privacy@propequitylab.com.au" className="text-sage hover:text-sage/80">privacy@propequitylab.com.au</a></p>
              <p className="text-foreground mt-2"><strong>Data Protection Officer:</strong> <a href="mailto:dpo@propequitylab.com.au" className="text-sage hover:text-sage/80">dpo@propequitylab.com.au</a></p>
            </div>
          </section>
