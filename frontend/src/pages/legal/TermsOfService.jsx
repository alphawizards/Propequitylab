    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-card rounded-lg shadow-card border border-border p-8 space-y-8">
          ...
          {/* User Data */}
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">4. Your Data</h2>
            <p className="text-foreground mb-4 leading-relaxed">
          ...
          {/* Disclaimers */}
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">6. Important Disclaimers</h2>

            <div className="bg-gold-soft border border-gold/30 rounded-lg p-4 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-4">9. Payments and Subscriptions</h2>
            <p className="text-foreground mb-4 leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-muted border border-border rounded-lg p-4">
              <p className="text-foreground"><strong>Email:</strong> <a href="mailto:legal@propequitylab.com.au" className="text-sage hover:text-sage/80">legal@propequitylab.com.au</a></p>
              <p className="text-foreground mt-2"><strong>Support:</strong> <a href="mailto:support@propequitylab.com.au" className="text-sage hover:text-sage/80">support@propequitylab.com.au</a></p>
            </div>
          </section>
