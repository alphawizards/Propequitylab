...
async def create_valuation(
    ...
    property_obj = verify_property_access(data.property_id, current_user.id, session)
...
async def get_valuation(
    ...
    # Verify property access
    verify_property_access(valuation.property_id, current_user.id, session)
...
async def get_latest_valuation(
    ...
    """
    # Verify property access
    property_obj = verify_property_access(property_id, current_user.id, session)
